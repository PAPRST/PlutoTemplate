...
# Seems to fix the problem of IP repositories
set adi_libs $ad_hdl_dir/library
puts $lib_dirs
puts $fpga_ip
puts $adi_libs
set_property  ip_repo_paths [list ${fpga_ip} ${lib_dirs} ${adi_libs}] [current_project]
update_ip_catalog

# NATS : this make it works because of IP path
#set_property ip_repo_paths {/home/nats/data/projects/oscimp/hdl/library/} [current_project]
